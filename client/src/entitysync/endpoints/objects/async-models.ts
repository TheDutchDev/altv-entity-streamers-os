...
class AsyncModel {
    private loadingModels = new Set( );
    private loadedModels : Map<number, number> = new Map( );
    ...
    // unloadAllModels() {
    //     for( let hash in this.loadedModels ) {
    //         natives.setModelAsNoLongerNeeded( hash );
    //     }
    //
